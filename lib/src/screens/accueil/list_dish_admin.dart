...
class ListDishAdmin extends StatefulWidget {
  const ListDishAdmin({Key? key}) : super(key: key);
  static const routeName = '/ListDishAdmin';
  @override
  State<ListDishAdmin> createState() => _ListDishAdminState();
}

class _ListDishAdminState extends State<ListDishAdmin> {
                            ...
                            child: ListTile(
                              ...
                              trailing: Row(
                                ...
                                children: [
                                  ...
                                  IconButton(
                                    onPressed: () async {
                                      log(_dishs![index].id.toString());
                                      mydb.db.rawDelete(
                                          'DELETE FROM food WHERE id = ?',
                                          [_dishs![index].id]).then(
                                        (value) {
